...
import { IGetAllUsersResponse, IGetUserResponse, IAddUserResponse, IUser, IAddUser } from '../models/UserModel';

import { GET, POST, USER_URL, BASIC_CONTENT_TYPE_ONLY_HEADERS } from '../constants';
...
export class UsersServices implements IUsersServices {
  ...
  private readonly _apiManager: IApiManager<IUser[]> | IApiManager<IAddUser> | IApiManager<IUser>;
  ...
  async addUser(userData: IUser): Promise<IAddUserResponse> {
    ...
    return {
      ...
      data: postResponse.data as IAddUser,
    };
  }
}
